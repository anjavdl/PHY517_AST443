...
\unusabledates{Run 1 needs to be scheduled to catch phase 0 of the eclipsing binary, on Oct. 20, Oct. 25, Oct. 30 or Nov. 4.  Run 2: please avoid Apr. 1 (proposers have a mid-term the next morning).}
...
\begin{list}{-}{\setlength{\leftmargin}{1.5cm}}
\setlength{\itemsep}{-0.2cm}
\item[+1 week:] 
\item[+2 weeks:] 
\item[+3 weeks:] 
\item[+4 weeks:] Submit the lab report.
\end{list}
...
\begin{targettable}{Run 2: Spectrograph}
